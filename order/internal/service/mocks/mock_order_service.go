...
func (_m *OrderService) CreateOrder(ctx context.Context, userUUID string, partUUIDs []string) (string, int64, error) {
...
func (_c *OrderService_CreateOrder_Call) Return(orderUUID string, totalPriceCents int64, err error) *OrderService_CreateOrder_Call {
	_c.Call.Return(orderUUID, totalPriceCents, err)
	return _c
}

func (_c *OrderService_CreateOrder_Call) RunAndReturn(run func(context.Context, string, []string) (string, int64, error)) *OrderService_CreateOrder_Call {
	_c.Call.Return(run)
	return _c
}
